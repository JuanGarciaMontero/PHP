...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  if (empty($_POST["name"])) {
    $nameErr = "Introduzca un Nombre";
  } else {
    $name = test_input($_POST["name"]);
    // check if name only contains letters and whitespace
    if (!preg_match("/^[a-zA-Z-' ]*$/",$name)) {
      $nameErr = "Introduzca solo letras y espacios en blaco";
    }
  }
  
  if (empty($_POST["email"])) {
    $emailErr = "Introduzca E-mail";
  } else {
...
<h2> Formulario ejemplo de validacion</h2>
